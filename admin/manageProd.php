        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="glyphicon glyphicon-plus" style='margin-left:5%;'></span><a href="insertCat.php" style='color:white;'> Add new Category</a>
                      ...
                      foreach ($categories as $category)
                      {
                        if($category->parent !== null)
                        {
                            ...
                            foreach ($products as $product)
                            {
                                ...
                                echo "<div class='col-md-6' style='margin-left:10%;'>$product->product_name</div>";
                                echo "<div class='col-md-2'> <a href='updateProd.php?product_id=$product->product_id' class='edit'>Update <span class='glyphicon glyphicon-edit'></span></a></div>";
                                echo "<div class='col-md-2'> <a href='deleteProd.php?product_id=$product->product_id' class='trash'>Delete <span class='glyphicon glyphicon-trash'></span></a></div>";
                                echo "</div>";
                            }
                          }
                				}
